  ...
  (function() {
    ...
    class GMValueManager {
      ...
      getValue(name, defaultValue) {
        ...
        this.bridge.call("getValue", { name, defaultValue }).then((value) => this.cache.set(name, value)).catch(() => {
        });
        return defaultValue;
      }
          ...
          const fn = (arg1, arg2, arg3 = {}) => {
            try {
              ...
              if (typeof arg1 === "string") {
                ...
                parent = lower === "style" || lower === "script" || lower === "link" ? document.head || document.documentElement || document.body : document.body || document.documentElement || document.head;
              } else {
                parent = arg1;
                tag = arg2;
